function h = getVoltFromWH(varargin)
% GETVOLTFROMWH Gey the Volterra Kernel of Wiener-Hammerstein model
%   h = getVoltFromWH(AI,AF,M,P,ALPHA,BETA,F)
...
function [A, B, M, p, alpha, beta, f] = attemptParseArgs(varargin)
    ...
    parser = inputParser();
    parser.addRequired('Ai');
    parser.addRequired('Af');
