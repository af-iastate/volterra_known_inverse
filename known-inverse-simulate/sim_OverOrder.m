...
[h_temp_i, K] = applyPolymap(g, M, K, f);  % apply polymap
[h_temp_sz, K] = applyPolymap(h_temp_i, M, K, f);  % apply polymap again

h_true = zeros(size(h_temp_sz));
h_true(1:numel(h_temp_i)) = h_temp_i;
...
simulationRound(h_true, M, K, 'lpspn2_overorder', f_filter, f_filter2, ...
